...
based on Event Sourcing, EventModeling, Dynamic Context Boundary and Vertical Slice Architecures.
...
Features:
- Java 17+
- Minimal dependencies (JDBC Driver, Connection pool and logging API)
- Postgres DB storage option with event append notifications to minimize eventual consistency delays
- In-Memory storage option for fast demo's and unit-testing without
